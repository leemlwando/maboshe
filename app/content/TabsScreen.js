...
export default class TabsScreen extends Component {
    ...
    createNewRide() {
        ToastAndroid.show('Mechanic Reuqest Successfull', ToastAndroid.SHORT);
    }
        ...
        return (
            <View style={styles.container}>
                <View style={styles.tabContainer}>
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity onPress={() => this.props.handler(mini)}>
                            ...
                            <Text style={styles.cabTypeText}>Pilatus</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity onPress={() => this.props.handler(sedan)}>
                            ...
                            <Text style={styles.cabTypeText}>Auto Spare</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity onPress={() => this.props.handler(suv)}>
                            ...
                            <Text style={styles.cabTypeText}>NginX</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                ...
                <View style={styles.rideContainer}>
                    ...
                    <View >
                    <Text style={styles.cabTypeButton}>Request A Mechanic</Text>
                    </View>
                    </TouchableOpacity>
                </View>
            </View>
